...
test('background badges and conflicts',()=>{assert.equal(validated({background_type:'commemorative',background_evidence:bg('commemorative_location_badge','location_style_background')}).effective_background_type,'commemorative');assert.equal(validated({background_type:'special',background_evidence:bg('special_background_badge','event_special_background')}).effective_background_type,'special');assert.equal(validated({background_type:'commemorative',background_evidence:bg('commemorative_location_badge','event_special_background')}).effective_background_type,'uncertain');assert.equal(validated({background_type:'special',background_evidence:bg('special_background_badge','location_style_background')}).effective_background_type,'uncertain');});
